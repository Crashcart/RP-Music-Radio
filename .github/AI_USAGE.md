...
| **Opus 4.7** | Architect / Auditor | Architecture, security audits, complex analysis, planning | Highest |
...
|-----------|--------------|----------|-------|
| Architecture / TDR updates | **Opus 4.7** | Human | Strategic; never delegate down |
| `PLANNING.md` / governance edits | **Opus 4.7** | Human | Rule 10 protected files |
