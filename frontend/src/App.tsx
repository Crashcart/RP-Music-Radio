<<<<<<< HEAD
import { useState, useEffect, useRef } from 'react'; // Trigger HMR
...
import { Brands } from "./pages/Brands";
import { DraftingTable } from "./pages/DraftingTable";
>>>>>>> 27195d048f731c9e141f3d0c5b0b5488561ec4c4
...
function SettingsPage({ apiOk }: { apiOk: boolean | null }) {
  ...
  const handleImport = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      alert(
        "⚠️ Import support is coming soon. For now, use the export for backup and manual restoration.",
      );
    } catch (err: any) {
    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: "var(--space-md)" }}>
        <div className="card-header">
          ...
          {keyStatus && (
            <span
              className={`badge ${keyStatus.configured ? "badge-completed" : "badge-failed"}`}
            >
        ...
        >
          <div className="form-group" style={{ flex: 1 }}>
            ...
            >
              Get your free Gemini 2.0 API key from{" "}
              <a
      ...
      <div className="card" style={{ marginBottom: "var(--space-md)" }}>
        <div className="card-header">
          ...
          <span
            className={`badge ${apiOk ? "badge-completed" : "badge-failed"}`}
          >
            <span className="badge-dot" />
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem" }}>
          The AetherWave API is currently routed through your active network
          connection. Make sure the Docker stack is running:{" "}
      ...
      <div className="card" style={{ marginBottom: "var(--space-md)" }}>
        ...
        >
          Export your entire relational database (Stations, DJs, Brands,
          Jingles, and Drafts) to a JSON file. Keep this file safe as a backup
      ...
      <div className="card">
        ...
        >
          AetherWave is a headless Media Factory that generates procedural,
          lore-heavy radio content for game environments. It transforms
          user-defined seeds into self-contained Lore-Shard MP3s with embedded
          album art, scripts, backstories, and persistent AI voice signatures.
        </p>
        <div
          style={{
...
function SystemLogsViewer() {
  ...
  return (
    <div
      className="card"
      style={{ marginBottom: "var(--space-md)", marginTop: "var(--space-md)" }}
    >
      <div
